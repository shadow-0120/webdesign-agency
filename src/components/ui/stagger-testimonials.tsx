...
const unsplashFaces = [
  ...
  "https://images.unsplash.com/photo-1628157588553-5eeea00af15c?auto=format&fit=crop&w=150&q=80",
...
export const StaggerTestimonials: React.FC = () => {
  ...
  return (
    <div
      ...
      className="relative w-full overflow-hidden bg-black rounded-[20px]  "
      style={{ height: 600 }}
    >
